 ...
 * @author Alejandro RG
 */
public class frmBajasMascotas extends javax.swing.JFrame {
    ConexionBD con = new ConexionBD("tiendamascotas");

    /**
     * Creates new form frmBajasMascotas
     */
    public frmBajasMascotas() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bajas Mascotas");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        int op = JOptionPane.showConfirmDialog(this, "¿Estas seguro en eliminar "
                + "este registro?");
        if(op==JOptionPane.OK_OPTION) {
            String enunciadoSQL = "DELETE FROM mascotas WHERE claveMascota="
                    + "'"+clave+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBajasMascotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBajasMascotas().setVisible(true);
            }
        });
    }
